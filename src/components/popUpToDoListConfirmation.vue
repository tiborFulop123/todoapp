    ...
    >
      ...
      >
        ...
        >
          ...
          <button type="button" class="confirm-button" @click="yesConfirm">
            Confirm
          </button>
        </div>
      </div>
...
<!-- lenyeg h csinalj egy confirm-button classt s arra apply-olod ezt a sok tailwindes classot

s akkor a ket gombnak csak ezt a confirm-button-t kell megadd s egybol rovidul a template -->
